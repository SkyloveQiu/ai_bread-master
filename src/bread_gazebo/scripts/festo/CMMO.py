...
from festo.CVE import CVE, formatBin
...
class CMMO:
    ...
    def reset_error(self,verbose=False, veryVerbose=False,sleepTime=.01):
        """
        ...
        """
        s = self.cve.writeControl(0x00000087)
        if verbose:
    ...
    def moveTo(self, record=1, sleepTime=.01, verbose=False, veryVerbose=False):
        """
